    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock", "root", "root");
...
// TODO add your handling code here:
    ...
    if (qun.isEmpty() || pri.isEmpty()) {
        jTextField5.setText(""); // clear total price if input is invalid
        return;
    }
    ...
    try {
        ...
        int N4 = N1 * (N3 - 10); // your custom calculation
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock","root","root");
